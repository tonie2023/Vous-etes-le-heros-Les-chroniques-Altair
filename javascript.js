...
let destinpositif = {
  ...
  img:,
  options:
    text: [{"Amavia offre à Malgus d'intégrer son armée", "Rester en cellule une journée de plus"}],
};
let destinnegatif = {
...
let premierscombats= {
  ...
  img:,
  options: [{
    text: "La commandante Amavia et la commandante Anna deviennent tes plus proches alliées", "Malgus se fait de nombreux alliés dont la commandante Amavia et Anna", "Malgus ne réussit qu'à avoir qu'un seul allié"}],
};
